...
// Dernière mise à jour : 15/11/2023 par DIVET Ethan
?>
<!DOCTYPE html>
<html>
<head>
...
$unUtilisateur = new Utilisateur(0, "toto", "mdputilisateur", "ethan.divet@gmail.com", "5566778899", 2, date('Y-m-d H:i:s', time()), 0, null);
$ok = $dao->creerUnUtilisateur($unUtilisateur);
$dao->modifierMdpUtilisateur("toto", "mdpadmin");
